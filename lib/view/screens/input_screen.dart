...
class _InputScreenState extends State<InputScreen> {
  ...
  void attemptCreateItem() async {
    ...
    Get.offAllNamed('/'); // 아이템 생성 시 리스트 갱신 효과를 주기 위해.(그런데 내정보의 MyItems는 갱신되지 않음..)
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '•객관식의 정답은 1개 숫자만 입력해주세요.(복수 답안 선택 기능은 검토중)',
                              style: TextStyle(
                                color: Color(0xffb43831),
                                fontFamily: 'SDneoR',
                                fontSize: 14,
                            ...
                            Text(
                              '•주관식의 정답은 정확히 글자와 띄어쓰기가 일치해야 하므로 가급적 띄어쓰기가 없는 단답형을 권장합니다.',
                              style: TextStyle(
                                color: Color(0xffb43831),
                                fontFamily: 'SDneoR',
                                fontSize: 14,
