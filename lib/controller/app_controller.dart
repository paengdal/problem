...
import 'package:quiz_first/pages/notification_details_page_back.dart';
...
class AppController extends GetxController {
  ...
  Future<bool> initialize() async {
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage rm) {
      Get.to(NotificationDetailsPageBack(), arguments: rm.data['argument']);
    });
    ...
    if (initialMessage != null) {
      Get.to(NotificationDetailsPageTermi(),
